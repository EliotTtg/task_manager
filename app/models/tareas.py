...
class Tarea:
    ...
    def __str__(self):
        return f'Tarea: [id: {self._id}, titulo: {self._titulo}, descripcion: {self._descripcion}, estado: {self._estado}, fecha_creacion: {self._fecha_creacion}, fecha_limite: {self._fecha_limite}, usuario_id: {self._usuario_id}]'
